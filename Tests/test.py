...
query_pow, ssc_pow = SpeedLayer.speed_connection.activate_powietrze_stream(model_path=powietrze_path)
...
query_urz, ssc_urz = SpeedLayer.speed_connection.activate_urzedy_stream(model_path=urzedy_path)
...
query_vel, ssc_vel = SpeedLayer.speed_connection.activate_velib_stream(model_path=velib_path)
